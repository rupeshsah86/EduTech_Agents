...
export const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-2xl shadow-xl flex flex-col h-full overflow-hidden">
      ...
      {/* Top Header Bar */}
      <div className="px-4 py-3.5 border-b border-slate-100 dark:border-neutral-800 flex items-center justify-between bg-slate-50/70 dark:bg-neutral-950/70 backdrop-blur-md shrink-0 min-h-[60px]">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-purple-600 flex items-center justify-center text-white font-bold shadow-md shadow-purple-600/20 shrink-0">
            <MessageSquare className="w-4 h-4" />
          </div>
          <div className="space-y-0.5">
            <h3 className="font-extrabold text-sm text-slate-900 dark:text-neutral-100 leading-tight">
              Sign Language AI Chat
            </h3>
            <p className="text-[10px] text-slate-400 dark:text-neutral-500 font-medium leading-tight">
      ...
      <div className="p-3.5 border-t border-slate-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 space-y-2.5 shrink-0 pr-16 sm:pr-4">
        ...
        {inputTab === 'sign' && (
          <div className="flex items-center gap-2 p-2.5 rounded-xl bg-purple-500/5 border border-purple-500/20">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 disabled:opacity-40 text-white font-bold text-xs flex items-center gap-1.5 transition-all cursor-pointer shadow-sm shrink-0 whitespace-nowrap"
            >
        ...
        {inputTab === 'keyboard' && (
          <form onSubmit={handleSubmit} className="flex items-center gap-2">
            <input
              ...
              className="flex-1 bg-slate-50 dark:bg-neutral-950 border border-slate-200 dark:border-neutral-800 rounded-xl px-4 py-2 text-xs text-slate-900 dark:text-neutral-100 focus:outline-none focus:border-purple-500 font-medium"
            />
            <button
              type="submit"
        ...
        {inputTab === 'mic' && (
          <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-neutral-950 border border-slate-200 dark:border-neutral-800">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl font-bold text-xs transition-all cursor-pointer shadow-sm shrink-0 whitespace-nowrap ${
