...
export const Navbar: React.FC<NavbarProps> = ({ darkMode, setDarkMode, activeAgentCount }) => {
  ...
  return (
    <header className="h-16 border-b border-slate-200/90 dark:border-slate-800/90 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl sticky top-0 z-40 px-6 flex items-center justify-between transition-colors duration-200 shadow-xs">
      {/* Brand Identity */}
      ...
      {/* Middle Status Badge */}
      <div className="hidden md:flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200/90 dark:border-slate-700/80 shadow-2xs">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200/60 dark:border-slate-700/60 transition-all relative cursor-pointer">
