  ...
  return (
    <header className="h-16 border-b border-slate-200/80 dark:border-neutral-800 bg-white/90 dark:bg-neutral-950/90 backdrop-blur-md sticky top-0 z-30 px-6 flex items-center justify-between gap-4 transition-colors duration-200">
      ...
      <div className="flex-1 max-w-xl relative">
        <div className="relative flex items-center bg-slate-100/80 dark:bg-neutral-900 border border-slate-200/80 dark:border-neutral-800 rounded-2xl px-3.5 py-2">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        {/* Voice AI Button */}
        <button
          className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 border border-purple-200/80 dark:border-purple-800/80 font-bold text-xs hover:bg-purple-100 dark:hover:bg-purple-900/50 transition-all cursor-pointer shadow-2xs"
        >
          ...
          <div className="hidden sm:block text-left">
            <div className="flex items-center gap-1">
              <p className="text-xs font-extrabold text-slate-900 dark:text-neutral-100 leading-tight">
                {user?.fullName?.toLowerCase() || 'nawas'}
              </p>
              <ChevronDown className="w-3 h-3 text-slate-400" />
            </div>
            <p className="text-[10px] text-purple-600 dark:text-purple-400 font-bold">Pro Student</p>
          </div>
        </div>
